...
except (AttributeError, LookupError): pass  # Python <3.7 or unsupported encoding
    ...
    if st.button("🐱 桌面宠物"):
        ...
        def _pet_req(q):
            def _do():
                ...
                except Exception: pass  # Non-critical: pet HTTP request best-effort (network may be unavailable)
